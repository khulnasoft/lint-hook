...
from aikit_lint.formatters import BaseFormatter
...
FILE_PATTERN = re.compile(
    r"(aikit/functional/frontends/(?!.*(?:config\.py|__init__\.py)$).*"
    r"|aikit_tests/test_aikit/(?!.*(?:__init__\.py|conftest\.py|helpers/.*|test_frontends/config/.*$)).*)"
)
