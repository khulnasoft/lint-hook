"""Docstring formatter for fixing aikit.array output style."""

import re

import black

from aikit_lint.formatters import BaseDocstringFormatter
from aikit_lint.strings import find_closing_parentheses


class AikitArrayDocstringFormatter(BaseDocstringFormatter):
    """
    Docstring formatter for fixing aikit.array output style.

    It checks for code examples that have `aikit.array` as it's output and
